    ...
    public static Map<DeviceStatusQueries.QueryType, String> queries = new HashMap<DeviceStatusQueries.QueryType, String>() {
        {
            ...
            put(DeviceStatusQueries.QueryType.SUCCESSFUL, "select * FROM devices WHERE " +
                    "properties.reported.firmware.fwUpdateStatus='Current' AND properties.reported.firmware.type='IoTDevKit'");
            put(DeviceStatusQueries.QueryType.FAILED, "select * FROM devices WHERE " +
                    "properties.reported.firmware.fwUpdateStatus='Error' AND properties.reported.firmware.type='IoTDevKit'");
        }
    };
}