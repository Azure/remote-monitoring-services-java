...
* "Open" the project with IntelliJ, the IDE should automatically recognize the
  ...
  status bar)
* Create a new Run Configuration, of type "SBT Task" and enter "run 54321"
...
* Test that the service is up and running pointing your browser to
  http://127.0.0.1:54321/v1/status
...
* From the console run `sbt -jvm-debug 9999 "run 54321"` to start the project
* Test that the service is up and running pointing your browser to
  http://127.0.0.1:54321/v1/status
...
dockerEntrypoint := Seq("bin/project-name-here")
```
