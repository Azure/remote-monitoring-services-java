...
public class LogoServiceModel {
    ...
    private static final Logger.ALogger log = Logger.of(LogoServiceModel.class);
    ...
    static {
        ...
        try {
            InputStream stream = LogoServiceModel.class.getResourceAsStream("../content/DefaultLogo.svg");
            ...
            // For some unknown reason, Java.lang.Class can not read resource
